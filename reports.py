...
def transactions_by_item_report(i_id):
	...
	content += '''</table>
					...
					<br />Report generated at: ''' + str(date.today().strftime("%d/%m/%Y")) + '''
					<br />Generated by: ''' + login.get_d_name() + '''
					<br /><br />Please note that the item's amount displayed in the top of the report, and in the listed transactions - is right at the moment of generating this report. '''
